										 ...
										 id_usuario = '" . $id . "'";
													...
													id = '" . $linha["id_produto"] . "'";
																	...
																	while ($linha2 = $consulta2->fetchArray()) { ?>
																			...
																			<td class="text-nowrap">R$ <?php echo number_format($linha2["preco"],2,",","."); ?></td>
																			<td align=center><?php echo $linha["quantidade"]; ?></td>
																			<td class="text-nowrap">R$ <?php echo number_format($linha2["preco"]*$linha["quantidade"],2,",","."); ?></td>
																			
																			<td>
																				<div class="text-center">
																					<a href="https://farmacia.swordsboy12.repl.co/usuarios/recibo.php?u_id=<?php echo $linha2["id"]; ?>" class="h3 justify-content-center"><i class="fa-solid fa-receipt"></i></a>
																				</div>
																			</td>
																			<td>
																				<a href="../produtos/delete_compra.php?u_id=<?php echo $linha2['id'] ?>" class="btn btn-danger">Deletar</a>
																			</td>
																	<?php } ?>
															</tr>
													<?php } ?>
								...
								<ul class="d-flex justify-content-around list-unstyled mt-auto">
									...
									<li class="d-flex align-items-center">
										<a href="../produtos/item.php?u_id=<?php echo $linha2["id"];?>"
											class="btn custom-btn">Ver Produto</a>
									</li>
								</ul>
							</div>
						</div>
